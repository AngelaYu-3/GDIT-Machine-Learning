...
This project is collaboration with UMD App-Development club, contracted by General Dynamics Information Technology. The goal is to create a ner-chunking based strategy for the development of a RAG (retrieval-augmented generation) LLM for an Email-AI querying chat bot.
